# Resolve Cyberpunk 2077 file/product version for RED4ext plugin version resources.
# When the game exe is absent (CI), use the newest entry in GameVersions.json.
...
set(_GAME_VERSIONS_FILE "${CMAKE_CURRENT_LIST_DIR}/GameVersions.json")
...
if(EXISTS "${CYBERPUNK_2077_GAME_DIR}/bin/x64/Cyberpunk2077.exe")
  ...
  file(READ ${_GAME_VERSIONS_FILE} GAME_VERSIONS)
  ...
  if(NOT UNKNOWN_GAME_VERSION STREQUAL "NOTFOUND")
    message(FATAL_ERROR "Unknown Game Version ${CYBERPUNK_2077_FILE_VERSION_STR} — update ${_GAME_VERSIONS_FILE}")
  endif()
  ...
  string(JSON CYBERPUNK_2077_FILE_VERSION_STR MEMBER ${GAME_VERSIONS} ${LAST_IDX})
  string(JSON CYBERPUNK_2077_GAME_VERSION_STR GET ${GAME_VERSIONS} ${CYBERPUNK_2077_FILE_VERSION_STR})
  ...
  message(STATUS "Game's FileVersion: ${CYBERPUNK_2077_FILE_VERSION_STR} (from GameVersions.json; exe not found)")
  message(STATUS "Game's Version: ${CYBERPUNK_2077_GAME_VERSION_STR}")
endif()
